                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 z-50">
                        <Card className="max-w-4xl w-full max-h-[90vh] overflow-y-auto bg-black border-primary/50">
                            <div className="relative">
                                ...
                                <Button variant="ghost" size="icon" onClick={() => setSelectedArtwork(null)} className="absolute top-3 right-3 bg-black/70 hover:bg-black/90 text-white">
                                    <X className="h-5 w-5" />
                                </Button>
                            ...
                            <div className="p-6 space-y-5">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="rounded-xl border border-primary/30 bg-primary/5 p-4">
                                        <p className="text-xs font-semibold text-primary">PÉRIODE</p>
                                        <p className="text-base font-bold text-white">{selectedArtwork.year || "Date inconnue"}</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex gap-2">
                                        {languages.map((lang) => (
                                            <Button
                                                ...
                                                className={language === lang.code ? "bg-primary text-black hover:bg-primary/90" : "border-primary/30 text-primary bg-transparent hover:bg-primary/10"}
                                            >
                                                {lang.label}
                                            </Button>
                                        ))}
                                ...
                                {audioUrl && (
                                    <div>
                                        <div className="mb-3 flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-semibold text-white">Guide audio</span>
                                        </div>
                                ...
                                <div className="rounded-xl border border-primary/30 bg-primary/5 p-5">
                                    <h3 className="font-serif font-bold text-primary mb-3">Description</h3>
                                    <p className="text-sm leading-relaxed text-muted-foreground">{description}</p>
                                </div>

                                <Button onClick={() => setSelectedArtwork(null)} className="w-full bg-primary hover:bg-primary/90 text-black" size="lg">
                                    Continuer la visite
                                </Button>
                            </div>
                        </Card>
